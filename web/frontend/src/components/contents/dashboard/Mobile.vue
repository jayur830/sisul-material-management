<template>
    <div id="mobile-dashboard" class="scroll">
            ...
            <table>
                ...
                <thead>
                    <tr>
                        <th>
                            시간
                            <font-awesome-icon size="lg" :icon="['fa', 'sort']" @click="orderLog({ property: 'logTime', order: !logOrder.logTime })" />
                        </th>
                        <th>
                            입/출고
                            <font-awesome-icon size="lg" :icon="['fa', 'sort']" @click="orderLog({ property: 'inOut', order: !logOrder.inOut })" />
                        </th>
                        <th>
                            종류
                            <font-awesome-icon size="lg" :icon="['fa', 'sort']" @click="orderLog({ property: 'category', order: !logOrder.category })" />
                        </th>
                        <th>
                            제품명
                            <font-awesome-icon size="lg" :icon="['fa', 'sort']" @click="orderLog({ property: 'item', order: !logOrder.item })" />
                        </th>
                        <th>
                            입/출고 수량
                        ...
                        <th>
                            작업자명
                            <font-awesome-icon size="lg" :icon="['fa', 'sort']" @click="orderLog({ property: 'workerName', order: !logOrder.workerName })" />
                        </th>
                        <th v-if="isAdmin"></th>
                    </tr>
                </thead>
...
<!--                <colgroup v-else>-->
                ...
                <thead>
                    <tr>
                        <th>
                            종류
                            <font-awesome-icon size="lg" :icon="['fa', 'sort']" @click="orderStock({ property: 'category', order: !stockOrder.category })" />
                        </th>
                        <th>
                            제품명
                            <font-awesome-icon size="lg" :icon="['fa', 'sort']" @click="orderStock({ property: 'item', order: !stockOrder.item })" />
                        </th>
                        <th>
                            수량
...
<!--                        <td colspan="3" v-else>-->
        ...
        <div class="content scroll animate__animated animate__fadeInDown" v-show="selectedStock" style="animation-delay: 0.6s;">
            <div>
                <h2>자재별 입/출고 내역</h2>
                <div>
            ...
            <table>
                ...
                <thead>
                    <tr>
                        <th>
                            시간
                            <font-awesome-icon size="lg" :icon="['fa', 'sort']" @click="orderStockView({ property: 'logTime', order: !selectedStockOrder.logTime })" />
                        </th>
                        <th>
                            입/출고
                            <font-awesome-icon size="lg" :icon="['fa', 'sort']" @click="orderStockView({ property: 'inOut', order: !selectedStockOrder.inOut })" />
                        </th>
                        <th>
                            수량
                            <font-awesome-icon size="lg" :icon="['fa', 'sort']" @click="orderStockView({ property: 'count', order: !selectedStockOrder.count })" />
                        </th>
                        <th>
                            근무반
                            <font-awesome-icon size="lg" :icon="['fa', 'sort']" @click="orderStockView({ property: 'workClass', order: !selectedStockOrder.workClass })" />
                        </th>
                        <th>
                            작업자명
                            <font-awesome-icon size="lg" :icon="['fa', 'sort']" @click="orderStockView({ property: 'workerName', order: !selectedStockOrder.workerName })" />
                        </th>
                    </tr>
                </thead>
                <tbody>
